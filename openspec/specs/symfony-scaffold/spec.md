...
Esqueleto de la aplicación Symfony en `app/`: estructura hexagonal, bundles base instalados y configurados, autenticación JWT disponible, logging, y una ruta `/health` que verifica el stack completo (nginx/php-fpm/Symfony/Postgres) funcionando sobre el docker-compose existente.
